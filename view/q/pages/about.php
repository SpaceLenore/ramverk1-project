<div class="wrap-text" style="border: 1px solid lightgrey; margin: 2rem 0; padding: 1rem;">
    <h1 style="text-align:center;">Om det här projektet</h1>
    <p>
        Questionable är en forumplattform för alla typer av frågor. Projektet är byggt
        för kusrsen Ramverk1@dbwebb och bygger på ramverket Anax. Ett urplock
        av de moduler som används är anax/database-active-record, anax/database-query-builder och
        anax/HTMLForm.
    </p>
    <p>
